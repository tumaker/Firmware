...
#define min_software_endstops true//cambiofalse // If true, axis won't move to coordinates less than HOME_POS.
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_X 0//100
      #define ABL_PROBE_PT_1_Y 10//50
      #define ABL_PROBE_PT_2_X 180//0
      #define ABL_PROBE_PT_2_Y 10//180
      #define ABL_PROBE_PT_3_X 100//180
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.4//-1.2//1.4//-12.35
  ...
  #define Z_RAISE_BEFORE_PROBING 4//15    //How much the extruder will be raised before traveling to the first probing point.
  #define Z_RAISE_BETWEEN_PROBINGS 4//5  //How much the extruder will be raised when traveling from between next probing points
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT (144)    // X point for Z homing when homing all axis (G28)
...
#define EXTRUDER_OFFSET_Y {0.0, 0.20}  // (in mm) for each extruder, offset of the hotend on the Y axis
